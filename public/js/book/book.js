...
function addPage(level_book, page, clave, book) {
	...
	if (book.turn('addPage', element, page)) {
		...
		// Load the page
		loadPage(level_book, page, clave, element);
	}

}

function loadPage(level_book, page, clave, pageElement) {
	...
	// Load the page
	img.attr('src', `https://dl.dropboxusercontent.com/s/${clave}/${page}.jpg`);
	loadRegions(level_book, page, pageElement);
...
// 	img.attr('src', '../images/pages/' +  page + '-large.jpg');
// }
...
// 	img.attr('src', '../images/pages/' +  page + '.jpg');
// }
